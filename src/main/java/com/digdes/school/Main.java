...
public class Main {
   ...
   public static void main(String... args){
       ...
       try {
           ...
           List<Map<String,Object>> result2 = starter.execute("INSERT VALUES 'lastName'='ЦЫганюк','id'=3, 'age'=1512,'active'=true,'cost'=69");
           ...
           List<Map<String,Object>> result4 = starter.execute("UPDATE VALUES 'active'=true,'id'=1  where 'id'=3");
